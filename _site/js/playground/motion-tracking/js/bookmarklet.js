...
overlay.innerHTML='<div style=\'position:fixed; border: 7px outset #ee4591; top: 30px; left: 30px; width:300px; height:185px; background-color: transparent; -moz-opacity:.50; filter:alpha(opacity=50); opacity:.50;\'><div style=\'margin:7px;\' id=\'cameraControl\'><object id=\'iembedflash\' classid=\'clsid:d27cdb6e-ae6d-11cf-96b8-444553540000\' codebase=\'http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0\' width=\'300\' height=\'185\'><param name=\'movie\' value=\'http://localhost.jessefulton.com/js/playground/motion-tracking/motion-tracking.swf\' /><param name=\'quality\' value=\'high\' /><param name=\'allowScriptAccess\' value=\'always\' /><embed allowScriptAccess=\'always\' id=\'embedflash\' src=\'http://localhost.jessefulton.com/js/playground/motion-tracking/motion-tracking.swf\' quality=\'high\' width=\'300\' height=\'185\' type=\'application/x-shockwave-flash\' pluginspage=\'http://www.macromedia.com/go/getflashplayer\' mayscript=\'true\' /></object></div></div>';
overlay = overlay.childNodes[0];
var j=document.body.appendChild(overlay);


overlay.onmouseover = function() {
	this.style.opacity = 1.0;
	this.style.filter = 'alpha(opacity=1.0)';
}
